...
MediaControlWindow::MediaControlWindow(lv_obj_t* parent, const char* title, const Asset icon, const char* sentence)
	: HomeWindow(parent, title){
	buildUI(icon, sentence);
}

void MediaControlWindow::buildUI(const Asset icon, const char* sentence){
	// Image
